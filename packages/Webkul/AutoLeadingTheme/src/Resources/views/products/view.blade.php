                ...
                >
                    ...
                    <div class="al-container">
                        <div class="al-product-detail">
                            ...
                            <!-- Product Info -->
                            <div class="al-product-info relative max-w-[590px] max-1180:w-full max-1180:max-w-full max-1180:px-5 max-sm:px-4">
                                {!! view_render_event('bagisto.shop.products.name.before', ['product' => $product]) !!}

                                <div class="flex justify-between gap-4">
                                    <h1 class="al-product-name text-3xl font-medium break-words max-sm:text-xl" v-pre>
                                        {{ $product->name }}
                                    </h1>
                                ...
                                <p class="al-product-price mt-[22px] flex items-center gap-2.5 text-2xl !font-medium max-sm:mt-2 max-sm:gap-x-2.5 max-sm:gap-y-0 max-sm:text-lg">
                                ...
                                <p class="al-description mt-6 text-lg text-zinc-500 max-sm:mt-1.5 max-sm:text-sm">
                                ...
                                {{-- Verification banner for unverified customers on booking/rental products --}}
                                @php
                                    $authCustomer = auth('customer')->user();
                                    $isBookingProduct = $product->type === 'booking';
                                    $showVerificationBanner = $isBookingProduct
                                        && $authCustomer
                                        && $authCustomer->verification_status !== 'approved';
                                @endphp

                                @if ($showVerificationBanner)
                                    <div class="al-verification-banner mt-6">
                                        <p class="al-verification-banner__title">
                                            {{ __('customer-verification::app.common.verification_required_to_rent') }}
                                        </p>
                                        <p class="al-verification-banner__message">
                                            {{ __('customer-verification::app.common.verification_incomplete_message') }}
                                        </p>
                                        <a href="{{ route('shop.customer.verification.index') }}" class="al-verification-banner__link">
                                            {{ __('customer-verification::app.common.verification_link_dashboard') }}
                                        </a>
                                    </div>
                                @endif

                                <!-- Quantity and Add-to-Cart -->
                                <div class="al-product-cta mt-8 flex max-w-[470px] gap-4 max-sm:mt-4">
                                ...
                                @if (core()->getConfigData('sales.checkout.shopping_cart.cart_page'))
                                    ...
                                    @if (core()->getConfigData('catalog.products.storefront.buy_now_button_display'))
                                        <x-shop::button
                                            type="submit"
                                            class="al-book-now-btn primary-button mt-5 w-full max-w-[470px] max-md:py-3 max-sm:mt-3 max-sm:rounded-lg max-sm:py-1.5"
