...
namespace Webkul\Wallet\DataGrids\Shop;
...
class WalletTransactionDataGrid extends DataGrid
{
    ...
    public function prepareColumns()
    {
        $this->addColumn([
            'index'              => 'type',
            'label'              => trans('bagisto-wallet::app.customers.account.wallet.type'),
            'type'               => 'string',
            'searchable'         => false,
            'sortable'           => true,
            'filterable'         => true,
        ...
        $this->addColumn([
            'index'      => 'amount',
            'label'      => trans('bagisto-wallet::app.customers.account.wallet.amount'),
            'type'       => 'string',
            'searchable' => false,
            'sortable'   => true,
            'filterable' => false,
        ...
        $this->addColumn([
            'index'      => 'remarks',
            'label'      => trans('bagisto-wallet::app.customers.account.wallet.remarks'),
            'type'       => 'string',
            'searchable' => true,
            'sortable'   => false,
            'filterable' => false,
        ...
        $this->addColumn([
            'index'           => 'created_at',
            'label'           => trans('bagisto-wallet::app.customers.account.wallet.date'),
            'type'            => 'date',
            'searchable'      => false,
            'sortable'        => true,
            'filterable'      => true,
