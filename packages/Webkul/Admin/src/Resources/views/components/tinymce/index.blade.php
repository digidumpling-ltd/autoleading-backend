            ...
            methods: {
                init() {
                    ...
                    tinyMCEHelper.initTinyMCE({
                        ...
                        toolbar1: 'formatselect | bold italic strikethrough | styles fontsizeinput forecolor backcolor image alignleft aligncenter alignright alignjustify | link hr |numlist bullist outdent indent  | removeformat | code | table | aibutton',
                        image_advtab: true,
