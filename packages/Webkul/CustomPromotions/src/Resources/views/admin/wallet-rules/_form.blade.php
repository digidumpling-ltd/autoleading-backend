    ...
    <div class="flex flex-1 flex-col gap-2 max-xl:flex-auto">
        ...
        <div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
            ...
            <v-promotion-coupon
                ...
                label-coupon-type="{{ trans('custom_promotions::app.admin.wallet-rules.create.coupon-type') }}"
                label-coupon-type-none="{{ trans('custom_promotions::app.admin.wallet-rules.create.coupon-type-none') }}"
                label-coupon-type-specific="{{ trans('custom_promotions::app.admin.wallet-rules.create.coupon-type-specific') }}"
                label-coupon-code="{{ trans('custom_promotions::app.admin.wallet-rules.create.coupon-code') }}"
                label-uses-per-coupon="{{ trans('custom_promotions::app.admin.wallet-rules.create.uses-per-coupon') }}"
                label-usage-per-customer="{{ trans('custom_promotions::app.admin.wallet-rules.create.usage-per-customer') }}"
            ></v-promotion-coupon>
        </div>
        ...
        <div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
            ...
            <x-admin::form.control-group class="!mb-0">
                <x-admin::form.control-group.label>
                    @lang('custom_promotions::app.admin.wallet-rules.create.end-other-rules')
                </x-admin::form.control-group.label>
                <x-admin::form.control-group.control
                    type="select"
                ...
                >
                    <option value="0">@lang('custom_promotions::app.admin.wallet-rules.create.end-other-rules-no')</option>
                    <option value="1">@lang('custom_promotions::app.admin.wallet-rules.create.end-other-rules-yes')</option>
                </x-admin::form.control-group.control>
            </x-admin::form.control-group>
        </div>
