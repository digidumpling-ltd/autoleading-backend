<x-admin::layouts>
    <x-slot:title>
        @lang('custom_promotions::app.admin.wallet-rules.create.title')
    </x-slot>

    <x-admin::form :action="route('admin.custom_promotions.wallet_rules.store')">
        ...
        <div class="mt-3 flex items-center justify-between gap-4 max-sm:flex-wrap">
            ...
            <div class="flex items-center gap-x-2.5">
                <a
                    href="{{ url()->previous(route('admin.custom_promotions.wallet_rules.index')) }}"
