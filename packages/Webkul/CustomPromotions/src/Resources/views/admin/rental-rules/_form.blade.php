<div class="mt-3.5 flex gap-2.5 max-xl:flex-wrap">
    ...
    <div class="flex flex-1 flex-col gap-2 max-xl:flex-auto">
        ...
        <div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
            <p class="mb-4 text-base font-semibold text-gray-800 dark:text-white">
                @lang('custom_promotions::app.admin.rental-rules.create.general')
            </p>

            <x-admin::form.control-group>
                <x-admin::form.control-group.label class="required">
                    @lang('custom_promotions::app.admin.rental-rules.create.name')
                ...
                <x-admin::form.control-group.control
                    ...
                    :label="trans('custom_promotions::app.admin.rental-rules.create.name')"
                    :placeholder="trans('custom_promotions::app.admin.rental-rules.create.name')"
                />
            ...
            <x-admin::form.control-group>
                ...
                <x-admin::form.control-group.control
                    ...
                    :label="trans('custom_promotions::app.admin.rental-rules.create.description')"
        ...
        <!-- Actions (Vue component — dynamic fields per action type) -->
        <div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
            <p class="mb-4 text-base font-semibold text-gray-800 dark:text-white">
                @lang('custom_promotions::app.admin.rental-rules.create.actions')
            </p>
            ...
            <v-rental-rule-actions
                ...
                :action-type-options='@json(trans("custom_promotions::app.admin.rental-rules.create.action-types"))'
                :reward-mode-options='@json(trans("custom_promotions::app.admin.rental-rules.create.reward-modes"))'
                label-action-type="{{ trans('custom_promotions::app.admin.rental-rules.create.action-type') }}"
                label-reward-mode="{{ trans('custom_promotions::app.admin.rental-rules.create.reward-mode') }}"
                label-reward-value="{{ trans('custom_promotions::app.admin.rental-rules.create.reward-value') }}"
                label-product-id="{{ trans('custom_promotions::app.admin.rental-rules.create.product-id') }}"
                label-extension-days="{{ trans('custom_promotions::app.admin.rental-rules.create.extension-days') }}"
                label-reward-value-fixed="{{ trans('custom_promotions::app.admin.rental-rules.create.reward-value-fixed') }}"
                label-reward-value-percent="{{ trans('custom_promotions::app.admin.rental-rules.create.reward-value-percent') }}"
    ...
    <div class="flex w-[360px] max-w-full flex-col gap-2 max-sm:w-full">
        ...
        <x-admin::accordion>
            <x-slot:header>
                <p class="p-2.5 text-base font-semibold text-gray-800 dark:text-white">
                    @lang('custom_promotions::app.admin.rental-rules.create.settings')
                </p>
            </x-slot>
            ...
            <x-slot:content>
                <x-admin::form.control-group>
                    <x-admin::form.control-group.label>
                        @lang('custom_promotions::app.admin.rental-rules.create.sort-order')
                    </x-admin::form.control-group.label>
                    <x-admin::form.control-group.control
                        type="text"
                        name="sort_order"
                ...
                <div class="mb-2.5">
                    <x-admin::form.control-group.label class="required">
                        @lang('custom_promotions::app.admin.rental-rules.create.channels')
                    </x-admin::form.control-group.label>
                    ...
                    @foreach(core()->getAllChannels() as $channel)
                        <x-admin::form.control-group class="!mb-2 flex items-center gap-2.5">
                            <x-admin::form.control-group.control
                                ...
                                :label="trans('custom_promotions::app.admin.rental-rules.create.channels')"
                ...
                <div class="mb-2.5">
                    <x-admin::form.control-group.label class="required">
                        @lang('custom_promotions::app.admin.rental-rules.create.customer-groups')
                    </x-admin::form.control-group.label>
                    ...
                    @foreach(app('Webkul\Customer\Repositories\CustomerGroupRepository')->all() as $group)
                        <x-admin::form.control-group class="!mb-2 flex items-center gap-2.5">
                            <x-admin::form.control-group.control
                                ...
                                :label="trans('custom_promotions::app.admin.rental-rules.create.customer-groups')"
                ...
                <x-admin::form.control-group>
                    ...
                    <x-admin::form.control-group.control
                        ...
                        name="status"
                        value="1"
                        :label="trans('custom_promotions::app.admin.rental-rules.create.status')"
        ...
        <x-admin::accordion>
            <x-slot:header>
                <p class="p-2.5 text-base font-semibold text-gray-800 dark:text-white">
                    @lang('custom_promotions::app.admin.rental-rules.create.marketing-time')
                </p>
            </x-slot>
            ...
            <x-slot:content>
                <x-admin::form.control-group>
                    <x-admin::form.control-group.label>
                        @lang('custom_promotions::app.admin.rental-rules.create.starts-from')
                    </x-admin::form.control-group.label>
                    <x-admin::form.control-group.control
                        type="date"
                        name="starts_from"
                ...
                <x-admin::form.control-group class="!mb-0">
                    <x-admin::form.control-group.label>
                        @lang('custom_promotions::app.admin.rental-rules.create.ends-till')
                    </x-admin::form.control-group.label>
                    <x-admin::form.control-group.control
                        type="date"
                        name="ends_till"
...
<script type="text/x-template" id="v-rental-rule-actions-template">
    <div>
        ...
        <!-- Reward Mode — for reward_points, wallet_credit, reward_product -->
        <div class="mb-4" v-show="actionType === 'reward_points' || actionType === 'wallet_credit' || actionType === 'reward_product'">
            <label class="mb-1.5 flex items-center gap-1 text-xs font-medium text-gray-800 dark:text-white required">
                @{{ labelRewardMode }}
            </label>
            <select
            ...
            >
                ...
                <template v-if="actionType === 'reward_product'">
                    <option v-for="(label, key) in productRewardModeOptions" :key="key" :value="key">@{{ label }}</option>
                </template>
                <template v-else>
                    <option v-for="(label, key) in rewardModeOptions" :key="key" :value="key">@{{ label }}</option>
                </template>
            </select>
        </div>

        <!-- Reward Value — label + control changes based on action type and mode -->
        <div class="mb-4" v-show="actionType !== '' && !(actionType === 'reward_product' && rewardMode === 'note')">
            <label class="mb-1.5 flex items-center gap-1 text-xs font-medium text-gray-800 dark:text-white required">
                <template v-if="actionType === 'reward_product'">@{{ labelProductId }}</template>
                <template v-else-if="actionType === 'free_extension'">@{{ labelExtensionDays }}</template>
                <template v-else-if="rewardMode === 'percentage'">@{{ labelRewardValuePercent }}</template>
                <template v-else>@{{ labelRewardValueFixed }}</template>
            </label>
            <input
                type="text"
                v-model="rewardValue"
        ...
        <!-- Note text — only for reward_product + note mode -->
        <div class="mb-4" v-show="actionType === 'reward_product' && rewardMode === 'note'">
            <label class="mb-1.5 flex items-center gap-1 text-xs font-medium text-gray-800 dark:text-white required">
                @{{ labelNoteText }}
            </label>
            <textarea
        ...
        <!-- Single hidden input always submits reward_value -->
...
<script>
    window.addEventListener('load', function () {
        app.component('v-rental-rule-actions', {
            template: '#v-rental-rule-actions-template',
            ...
            props: {
                ...
                labelProductId:          { type: String, default: 'Reward Product ID' },
                labelExtensionDays:      { type: String, default: 'Extension Days' },
                labelRewardValueFixed:   { type: String, default: 'Fixed Amount' },
                labelRewardValuePercent: { type: String, default: 'Percentage (%)' },
                labelNoteText:           { type: String, default: 'Note / Description' },
                productRewardModeOptions: { type: Object, default: () => ({}) },
            },
