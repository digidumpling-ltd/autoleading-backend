                ...
                <x-shop::form :action="route('shop.customers.register.store')" enctype="multipart/form-data">
                    ...
                    <div class="mt-10">
                        <h2 class="text-lg font-semibold text-zinc-800">
                            {{ __('Upload Documents for Verification') }}
                        </h2>
                        <p class="mt-1 text-sm text-zinc-500">
                            {{ __('Please upload the required documents to complete your registration.') }}
                        </p>
                    </div>
                    ...
                    <div class="mt-6 grid grid-cols-1 gap-6 md:grid-cols-3">
                        <x-shop::form.control-group>
                            ...
                            <p class="text-xs text-zinc-500">
                                {{ __('Upload a photo of your ID (PNG, JPG, JPEG, WebP, max 5MB)') }}
                            </p>
                        ...
                        <x-shop::form.control-group>
                            ...
                            <p class="text-xs text-zinc-500">
                                {{ __('Upload a photo of your driver license (PNG, JPG, JPEG, WebP, max 5MB)') }}
                            </p>
                        ...
                        <x-shop::form.control-group>
                            ...
                            <p class="text-xs text-zinc-500">
                                {{ __('Upload proof of address (PNG, JPG, JPEG, WebP, PDF, max 5MB)') }}
                            </p>
                    ...
                    {!! view_render_event('bagisto.shop.customers.signup_form.documents.after') !!}
