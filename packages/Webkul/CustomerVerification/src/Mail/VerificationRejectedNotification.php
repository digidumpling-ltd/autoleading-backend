...
class VerificationRejectedNotification extends Mailable implements ShouldQueue
{
    ...
    public function envelope(): Envelope
    {
        return new Envelope(
            ...
            subject: trans('customer-verification::app.emails.verification-rejected.subject'),
        );
    }
    ...
    {
        return new Content(
            view: 'customer-verification::emails.verification-rejected',
        );
    }
