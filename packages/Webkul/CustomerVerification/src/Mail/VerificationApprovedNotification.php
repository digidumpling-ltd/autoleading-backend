...
class VerificationApprovedNotification extends Mailable implements ShouldQueue
{
    ...
    public function envelope(): Envelope
    {
        return new Envelope(
            ...
            subject: trans('customer-verification::app.emails.verification-approved.subject'),
        );
    }
    ...
    {
        return new Content(
            view: 'customer-verification::emails.verification-approved',
        );
    }
