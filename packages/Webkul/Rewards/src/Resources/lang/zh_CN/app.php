    ...
    'admin' => [
        'components' => [
            'layouts' => [
                'sidebar' => [
                    ...
                    'wallet-topup-reward-rules'                  => '钱包奖励积分',
                ],
            ],
        ],
        ...
        'rewards' => [
            ...
            'wallet-topup' => [
                'index' => [
                    'add-btn'        => '添加钱包奖励规则',
                    'create-success' => '钱包奖励规则创建成功',
                    'delete-failed'  => '钱包奖励规则删除失败',
                    'delete-success' => '钱包奖励规则删除成功',
                    'title'          => '钱包奖励规则',
                    'update-success' => '钱包奖励规则更新成功',
                    ...
                    'datagrid' => [
                        ...
                        'status'                => '状态',
                        'trigger'               => '触发器',
                        'trigger-wallet-spend'  => '钱包消费',
                        'trigger-wallet-topup'  => '钱包充值',
                        'update-status'         => '更新状态',
                        'value'                 => '积分值',
