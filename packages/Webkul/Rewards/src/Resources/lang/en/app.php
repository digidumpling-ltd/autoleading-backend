...
return [
    ...
    'admin' => [
        'components' => [
            'layouts' => [
                'sidebar' => [
                    ...
                    'wallet-topup-reward-rules'                  => 'Reward Point on Wallet',
                ],
            ],
        ],
        ...
        'rewards' => [
            ...
            'wallet-topup' => [
                'index' => [
                    'add-btn'        => 'Add Wallet Reward Rule',
                    'create-success' => 'Wallet Reward Rule created successfully',
                    'delete-failed'  => 'Wallet Reward Rule could not be deleted',
                    'delete-success' => 'Wallet Reward Rule deleted successfully',
                    'title'          => 'Wallet Reward Rules',
                    'update-success' => 'Wallet Reward Rule updated successfully',
                    ...
                    'datagrid' => [
                        ...
                        'status'                => 'Status',
                        'trigger'               => 'Trigger',
                        'trigger-wallet-spend'  => 'Wallet Spend',
                        'trigger-wallet-topup'  => 'Wallet Topup',
                ...
                'create' => [
                    ...
                    'mode-percent'           => 'Percent of Amount',
                    'priority'               => 'Priority',
                    'save-btn'               => 'Save Rule',
                    ...
                    'status'                 => 'Status',
                    'title'                  => 'Add Wallet Reward Rule',
                    'trigger'                => 'Trigger',
                    'trigger-wallet-spend'   => 'Wallet Spend',
                    'trigger-wallet-topup'   => 'Wallet Topup',
                    'value'                  => 'Points Value',
                    'value-fixed'            => 'Reward Points',
                    'value-percent'          => 'Percentage of Amount (%)',
                ],

                'edit' => [
                    'save-btn' => 'Update Rule',
                    'title'    => 'Edit Wallet Reward Rule',
                ],
            ],
