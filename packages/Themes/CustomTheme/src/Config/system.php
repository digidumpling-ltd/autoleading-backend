...
return [
    ...
    [
        ...
        'fields' => [
            ...
            [
                'name' => 'facebook_url',
                'title' => 'custom-theme::app.configuration.general.design.footer.facebook-url',
                'type' => 'text',
                'channel_based' => true,
                'locale_based' => false,
            ],
            [
                'name' => 'instagram_url',
                'title' => 'custom-theme::app.configuration.general.design.footer.instagram-url',
                'type' => 'text',
                'channel_based' => true,
                'locale_based' => false,
            ],
            [
                'name' => 'twitter_url',
                'title' => 'custom-theme::app.configuration.general.design.footer.twitter-url',
                'type' => 'text',
                'channel_based' => true,
                'locale_based' => false,
            ],
            [
                'name' => 'youtube_url',
                'title' => 'custom-theme::app.configuration.general.design.footer.youtube-url',
                'type' => 'text',
                'channel_based' => true,
                'locale_based' => false,
            ],
            [
                'name' => 'tiktok_url',
                'title' => 'custom-theme::app.configuration.general.design.footer.tiktok-url',
                'type' => 'text',
                'channel_based' => true,
                'locale_based' => false,
            ],
