    ...
    <div class="mx-4 flex-auto max-md:mx-6 max-sm:mx-4">
        ...
        >
            ...
            <x-shop::form.control-group>
                ...
                <p class="w-full rounded-lg border border-zinc-200 bg-zinc-50 px-3 py-2.5 text-base text-zinc-700">
                    {{ $customer->first_name }}
                </p>
            ...
            <!-- Phone (editable if empty, read-only if set) -->
            <x-shop::form.control-group>
                <x-shop::form.control-group.label class="{{ $customer->phone ? '' : 'required' }}">
