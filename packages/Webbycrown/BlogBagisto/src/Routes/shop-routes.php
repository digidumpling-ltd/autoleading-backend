...
Route::group([
    ...
    Route::get('/post/{slug}', 'Webbycrown\BlogBagisto\Http\Controllers\Shop\BlogController@viewUncategorized')->defaults('_config', [
        'view' => 'blog::shop.velocity.view',
    ])->name('shop.article.view.uncategorized');
    ...
    Route::get('/api/v1/blog/tag', 'Webbycrown\BlogBagisto\Http\Controllers\Shop\API\Blogs\BlogController@tag_list')->name('shop.blog.tag.list');
