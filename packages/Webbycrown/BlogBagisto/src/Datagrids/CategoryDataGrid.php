...
class CategoryDataGrid extends DataGrid
{
    ...
    public function prepareQueryBuilder()
    {
        ...
        $queryBuilder = DB::table('blog_categories')
            ->leftJoin('blog_category_translations', function ($join) use ($locale) {
                $join->on('blog_categories.id', '=', 'blog_category_translations.blog_category_id')
            ...
            ->select(
                ...
                'blog_category_translations.name',
                'blog_category_translations.slug',
            );
