                    ...
                    <div class="container-right row no-margin col-12 no-padding">
                        ...
                        <div id="blog" class="container mt-5">
                            ...
                            <div id="comment-list" class="column-12 comment-part related-bolg-part">
                                <div class="col-lg-12"><h1 class="mb-3 mt-3 page-title">@lang('blog::app.shop.related-blog')</h1></div>
                                            ...
                                            <div class="blog-post-box">
                                                <div class="card mb-5">
                                                    <div class="blog-grid-img">
                                                        <img
                                                            src="{{ $related_blog->src ? \Illuminate\Support\Facades\Storage::url($related_blog->src) : bagisto_asset('images/medium-product-placeholder.webp') }}"
                                                            alt="{{ $related_blog->name }}"
                                                            class="card-img-top">
                                                    </div>
                                                    <div class="card-body">
                                                        <h2 class="card-title">
                                                            <a href="{{ $related_blog->category?->slug ? route('shop.article.view', [$related_blog->category->slug . '/' . $related_blog->slug]) : route('shop.article.view.uncategorized', [$related_blog->slug]) }}">{{ $related_blog->name }}</a>
                                                        </h2>
                                                        <div class="post-meta">
                                                            <p>
                                                                {{\Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $related_blog->created_at)->format('M j, Y') }} @lang('blog::app.shop.by')
                                                    ...
                                                    <div class="card-footer">
                                                        <a href="{{ $related_blog->category?->slug ? route('shop.article.view', [$related_blog->category->slug . '/' . $related_blog->slug]) : route('shop.article.view.uncategorized', [$related_blog->slug]) }}" class="primary-button">@lang('blog::app.shop.read-more')</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row flex flex-wrap grid-wrap">
                                        <div class="column-12">
                                            @if( (int)$blog->allow_comments == 1 )
                                                <h2>@lang('blog::app.shop.comments', ['count' => $total_comments_cnt])</h2>
                                                <div class="row flex flex-wrap grid-wrap">
                                                    ...
                                                    @if( $guest_comment_flag )
                                                        ...
                                                        <div class="column-12">
                                                            <div class="row justify-content-center mt-3 comment-form-holder flex flex-wrap grid-wrap">
                                                                <div class="column-12">
                                                                    <h3>@lang('blog::app.shop.leave-comment')</h3>
                                                                        ...
                                                                        <div class="form-row">
                                                                            <div class="form-group column-6">
                                                                                <div class="input-group">
                                                                                    ...
                                                                                    <input type="text" name="name" placeholder="{{ trans('blog::app.shop.your-name') }}" required="required" class="form-control" value="{{ ( isset($loggedIn_user_name) && !empty($loggedIn_user_name) && !is_null($loggedIn_user_name) ) ? $loggedIn_user_name : ''; }}">
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group column-6">
                                                                                <div class="input-group">
                                                                                    ...
                                                                                    <input type="email" name="email" placeholder="{{ trans('blog::app.shop.your-email') }}" required="required" class="form-control" value="{{ ( isset($loggedIn_user_email) && !empty($loggedIn_user_email) && !is_null($loggedIn_user_email) ) ? $loggedIn_user_email : ''; }}">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <textarea name="comment" placeholder="{{ trans('blog::app.shop.your-comment') }}" required="required" rows="5" class="form-control"></textarea>
                                                                        </div>
                                                                        <div class="form-group text-right">
                                                                            <button type="submit" class="btn btn-primary btn-lg">@lang('blog::app.shop.submit-comment')</button>
                                                                        </div>
                                                                    </form>
                                                                </div>
                                                            </div>
                                                    ...
                                                    @else
                                                        ...
                                                        <div class="column-12">
                                                            <div class="comment-not-allow-guest">
                                                                {!! trans('blog::app.shop.login-to-comment', ['url' => URL::to('/') . '/customer/login']) !!}
                                                            </div>
                                                        </div>
                                            ...
                                            @else
                                                <div class="comment-not-allow">@lang('blog::app.shop.comments-disabled')</div>
                                            @endif
                                        </div>
                                    </div>
                                </div>
