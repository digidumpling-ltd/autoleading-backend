...
<x-shop::layouts>
    {{-- Page Title --}}
    <x-slot:title>
        {{ trans('blog::app.shop.posts-by', ['author' => $author_data->author]) }}
    </x-slot>
                    ...
                    <div class="container-right row no-margin col-12 no-padding">
                        <div id="blog" class="container mt-5">
                            <div class="full-content-wrapper">
                                <div class="col-lg-12"><h1 class="mb-3 page-title">@lang('blog::app.shop.posts-by', ['author' => $author_data->author])</h1></div>
