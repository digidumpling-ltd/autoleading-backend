                ...
                <div class="p-4 bg-white dark:bg-gray-900 rounded-[4px] box-shadow">
                    ...
                    <x-admin::form.control-group class="mb-2.5">
                        ...
                        <v-field
                            ...
                            value="{{ old($currentLocale->code)['name'] ?? ($tag->translate($currentLocale->code)?->name ?? '') }}"
                    ...
                    <x-admin::form.control-group class="mb-2.5">
                        ...
                        <v-field
                            ...
                            value="{{ old($currentLocale->code)['slug'] ?? ($tag->translate($currentLocale->code)?->slug ?? '') }}"
                        ...
                        <v-description>
                            <x-admin::form.control-group class="mb-2.5">
                                ...
                                <x-admin::form.control-group.control
                                    ...
                                    class="description"
                                    rules="required"
                                    :value="old($currentLocale->code)['description'] ?? ($tag->translate($currentLocale->code)?->description ?? '')"
                    ...
                    <div class="mt-8">
                        ...
                        <x-admin::form.control-group class="mb-2.5">
                            ...
                            <x-admin::form.control-group.control
                                ...
                                id="meta_title"
                                rules="required"
                                :value="old($currentLocale->code)['meta_title'] ?? ($tag->translate($currentLocale->code)?->meta_title ?? '')"
                        ...
                        <x-admin::form.control-group class="mb-2.5">
                            ...
                            <x-admin::form.control-group.control
                                ...
                                rules="required"
                                :value="old($currentLocale->code)['meta_keywords'] ?? ($tag->translate($currentLocale->code)?->meta_keywords ?? '')"
                        ...
                        <x-admin::form.control-group class="mb-2.5">
                            ...
                            <x-admin::form.control-group.control
                                ...
                                id="meta_description"
                                rules="required"
                                :value="old($currentLocale->code)['meta_description'] ?? ($tag->translate($currentLocale->code)?->meta_description ?? '')"
