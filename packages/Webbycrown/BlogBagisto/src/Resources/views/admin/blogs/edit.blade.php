            ...
            <div class="flex flex-col gap-2 flex-1 max-xl:flex-auto">
                ...
                <div class="p-4 bg-white dark:bg-gray-900 rounded box-shadow">
                    ...
                    <x-admin::form.control-group class="mb-2.5">
                        ...
                        <v-field
                            ...
                            value="{{ old($currentLocale->code)['name'] ?? ($blog->translate($currentLocale->code)?->name ?? '') }}"
                ...
                <div class="p-4 bg-white dark:bg-gray-900 rounded box-shadow">
                    ...
                    <x-admin::form.control-group class="mb-2.5">
                        ...
                        <x-admin::form.control-group.control
                            type="textarea"
                            name="{{ $currentLocale->code }}[short_description]"
                            id="short_description"
                            rules="required"
                            :value="old($currentLocale->code)['short_description'] ?? ($blog->translate($currentLocale->code)?->short_description ?? '')"
                            :label="trans('blog::app.blog.short_description')"
                            :placeholder="trans('blog::app.blog.short_description')"
                        >
                        </x-admin::form.control-group.control>

                        <x-admin::form.control-group.error control-name="{{ $currentLocale->code }}[short_description]"></x-admin::form.control-group.error>
                    ...
                    <v-description>
                        <x-admin::form.control-group class="mb-2.5">
                            ...
                            <x-admin::form.control-group.control
                                ...
                                class="description"
                                rules="required"
                                :value="old($currentLocale->code)['description'] ?? ($blog->translate($currentLocale->code)?->description ?? '')"
...
@pushOnce('scripts')
    <script type="text/x-template" id="v-description-template">
        <div>
            <slot :is-description-required="true"></slot>
        </div>
    </script>
