<x-admin::layouts>
    ...
    >
        ...
        <!-- Locale Switcher -->
        @if (core()->getAllLocales()->count() > 1)
        <div class="mt-7 flex items-center gap-4 max-md:flex-wrap">
            <div class="flex items-center gap-x-1">
                ...
                >
                    <x-slot:toggle>
                        <button
                            type="button"
                            class="transparent-button px-1 py-1.5 hover:bg-gray-100 dark:hover:bg-gray-950"
                        >
                    ...
                    <x-slot:content class="!p-0">
                        @foreach (core()->getAllLocales() as $locale)
                            <a
                                href="?{{ \Illuminate\Support\Arr::query(['locale' => $locale->code]) }}"
                                class="flex gap-2.5 px-5 py-2 text-base cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-950
                                    {{ $locale->code === $currentLocale->code ? 'font-medium text-brandColor' : 'text-gray-600 dark:text-gray-300' }}"
                            >
                                {{ $locale->name }}
                            </a>
                        @endforeach
                ...
                <div class="p-4 bg-white dark:bg-gray-900 rounded box-shadow">
                    ...
                    <x-admin::form.control-group class="mb-2.5">
                        ...
                        <v-field
                            ...
                            value="{{ old($currentLocale->code)['name'] ?? ($categories->translate($currentLocale->code)?->name ?? '') }}"
                    ...
                    <x-admin::form.control-group class="mb-2.5">
                        ...
                        <v-field
                            ...
                            value="{{ old($currentLocale->code)['slug'] ?? ($categories->translate($currentLocale->code)?->slug ?? '') }}"
                    ...
                    <v-description>
                        <x-admin::form.control-group class="mb-2.5">
                            ...
                            <x-admin::form.control-group.control
                                ...
                                class="description"
                                rules="required"
                                :value="old($currentLocale->code)['description'] ?? ($categories->translate($currentLocale->code)?->description ?? '')"
                    ...
                    <div class="mt-8">
                        ...
                        <x-admin::form.control-group class="mb-2.5">
                            ...
                            <x-admin::form.control-group.control
                                ...
                                id="meta_title"
                                rules="required"
                                :value="old($currentLocale->code)['meta_title'] ?? ($categories->translate($currentLocale->code)?->meta_title ?? '')"
                                :label="trans('blog::app.blog.meta_title')"
                                :placeholder="trans('blog::app.blog.meta_title')"
                            >
                            </x-admin::form.control-group.control>

                            <x-admin::form.control-group.error :control-name="$currentLocale->code . '[meta_title]'"></x-admin::form.control-group.error>
                        ...
                        <x-admin::form.control-group class="mb-2.5">
                            ...
                            <x-admin::form.control-group.control
                                ...
                                rules="required"
                                :value="old($currentLocale->code)['meta_keywords'] ?? ($categories->translate($currentLocale->code)?->meta_keywords ?? '')"
                                :label="trans('blog::app.blog.meta_keywords')"
                                :placeholder="trans('blog::app.blog.meta_keywords')"
                            >
                            </x-admin::form.control-group.control>

                            <x-admin::form.control-group.error :control-name="$currentLocale->code . '[meta_keywords]'"></x-admin::form.control-group.error>
                        ...
                        <x-admin::form.control-group class="mb-2.5">
                            ...
                            <x-admin::form.control-group.control
                                ...
                                id="meta_description"
                                rules="required"
                                :value="old($currentLocale->code)['meta_description'] ?? ($categories->translate($currentLocale->code)?->meta_description ?? '')"
                                :label="trans('blog::app.blog.meta_description')"
                                :placeholder="trans('blog::app.blog.meta_description')"
                            >
                            </x-admin::form.control-group.control>

                            <x-admin::form.control-group.error :control-name="$currentLocale->code . '[meta_description]'"></x-admin::form.control-group.error>
