...
class BlogController extends Controller
{
     ...
     * @return \Illuminate\View\View
     */
    public function view($blog_slug, $slug = null)
    {
        $actualSlug = $slug ?? $blog_slug;
        $blog = Blog::whereTranslation('slug', $actualSlug)->firstOrFail();
    ...
    public function viewUncategorized($slug)
    {
        return $this->view($slug, null);
    }
