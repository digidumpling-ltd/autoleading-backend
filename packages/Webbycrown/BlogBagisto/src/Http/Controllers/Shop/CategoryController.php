...
class CategoryController extends Controller
{
    ...
    public function index($category_slug)
    {
        ...
        $category = Category::whereHas('translations', function ($q) use ($category_slug, $locale) {
            $q->where('slug', $category_slug)->where('locale', $locale);
        })->firstOr(function () use ($category_slug) {
            return Category::whereHas('translations', function ($q) use ($category_slug) {
